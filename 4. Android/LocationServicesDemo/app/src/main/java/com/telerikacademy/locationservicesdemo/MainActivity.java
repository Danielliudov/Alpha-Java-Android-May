...
public class  MainActivity extends AppCompatActivity {
    ...
    private static final String IS_REQUESTING_UPDATES = "is_requesting_updates";
    ...
    private void updateLocationUI() {
        if (mCurrentLocation != null) {
            txtLocationResult.setText(String.format("Lat: %f, Lng: %f", mCurrentLocation.getLatitude(), mCurrentLocation.getLongitude()));
    ...
    public void openMapClick() {
        if (mCurrentLocation != null) {
            ...
            viewMap.putExtra("lat", mCurrentLocation.getLatitude());
            viewMap.putExtra("lng", mCurrentLocation.getLongitude());
    ...
    public void showLastKnownLocation() {
        if (mCurrentLocation != null) {
            Toast.makeText(getApplicationContext(),
                    String.format("Lat: %f, Lng: %f", mCurrentLocation.getLatitude(), mCurrentLocation.getLongitude()),
